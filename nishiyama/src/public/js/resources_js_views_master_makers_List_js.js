"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_master_makers_List_js"],{

/***/ "./resources/js/views/master/makers/List.js":
/*!**************************************************!*\
  !*** ./resources/js/views/master/makers/List.js ***!
  \**************************************************/
...
/* harmony import */ var _MakersData__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./MakersData */ "./resources/js/views/master/makers/MakersData.js");
...
var getBadge = function getBadge(状態) {
  switch (状態) {
    case '有効':
      return 'success';
...
var MakersList = function MakersList() {
  ...
  var pageChange = function pageChange(newPage) {
    currentPage !== newPage && history.push("/master/makers/list?page=".concat(newPage));
  };
    ...
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(_coreui_react__WEBPACK_IMPORTED_MODULE_1__.CCol, {
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)(_coreui_react__WEBPACK_IMPORTED_MODULE_1__.CCard, {
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)(_coreui_react__WEBPACK_IMPORTED_MODULE_1__.CCardHeader, {
          children: ["\u30E1\u30FC\u30AB\u30FC\u30DE\u30B9\u30BF", /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(CButton, {
            color: "link",
            className: "px-0",
            children: "\u65B0\u898F\u767B\u9332"
          })]
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(_coreui_react__WEBPACK_IMPORTED_MODULE_1__.CDataTable, {
            items: _MakersData__WEBPACK_IMPORTED_MODULE_2__.default,
            fields: [{
              key: 'id',
            ...
            onRowClick: function onRowClick(item) {
              return history.push("/master/makers/detail/".concat(item.id));
            },
            scopedSlots: {
              '状態': function 状態(item) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (MakersList);
