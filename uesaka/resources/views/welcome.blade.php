        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <ul>
                ...
                <li>
                    <a>パスワードの再設定</a>
                    <div>
                        <form action="{{route('user.resetP')}}" method="POST">
                            @csrf
                            <?php var_dump(session()->get('name')); ?>
                            <label class="row form-label">ユーザ名</label><input class="row form-input" type="text" name="name">
                            <label class="row form-label">メールアドレス</label><input class="row form-input" type="text" name="email">
                            <label class="row form-label">新しいパスワード</label><input class="row form-input" type="password" name="password">
                            <div class="row">
                                <input class="form-button" type="submit" value="再登録">
                            </div>
                        </form>
                    </div>
                </li>
